...
try {
    ...
    $welcome_message = "Dear $fullname, welcome to CBE-Pros Digital Banking. Your username is: $username";
    $stmt = $conn->prepare("
        INSERT INTO notifications (user_id, title, message, type, created_at) 
        VALUES (?, 'Welcome to CBE-Pros!', ?, 'system', NOW())
    ");
...
?>
    ...
    <head>
        <title>Registration Successful - CBE-Pros</title>
        <style>
            body {
