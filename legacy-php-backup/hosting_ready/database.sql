-- Mesfin Digital Bank Database Schema
CREATE DATABASE IF NOT EXISTS mesfin_bank;
USE mesfin_bank;
-- Users Table
...
VALUES (
        2,
        'Welcome to Mesfin Digital Bank!',
        'Thank you for joining Mesfin Digital Bank Digital Banking.',
        'system',
        1
    ),
    (
