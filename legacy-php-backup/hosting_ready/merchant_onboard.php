...
<div class="section active" style="display:block;">
    <div class="auth-card" style="max-width: 600px; margin: 40px auto; padding: 40px; background: white; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
        <div style="text-align: center; margin-bottom: 30px;">
            ...
            <h2 style="color: #333; margin-bottom: 10px;">Grow Your Business with Mesfin Digital Bank Merchant</h2>
        ...
        <form id="merchantOnboardForm" onsubmit="handleMerchantOnboard(event)">
            ...
            <p style="font-size: 11px; color: #888; margin-bottom: 25px;">By upgrading, you agree to the Mesfin Digital Bank Merchant terms. A 1% merchant service fee applies to all incoming business payments.</p>
