...
<head>
    <meta charset="UTF-8">
    <title>Mesfin Digital Bank Official Statement - <?php echo $account_number; ?></title>
    <style>
...
<body>
    ...
    <div class="statement-container">
        <div class="stamp-overlay">
            <div class="stamp-circle">MESFIN DIGITAL BANK<br>OFFICIAL<br>LEDGER<br>ENTRY</div>
        </div>

        <div class="purple-header">
            <h1>Mesfin Digital Bank Digital Banking</h1>
        ...
        <div class="content">
            ...
            <div class="footer">
                <p>This statement is electronically generated and verified by the Mesfin Digital Bank Digital Core Engine. <br>
                Generated on: <?php echo date('Y-m-d H:i:s'); ?> | Server IP: <?php echo $_SERVER['SERVER_ADDR']; ?></p>
                <h4 style="color: #800080; margin-top: 15px;">Mesfin Digital Bank: Modern Banking, Universal Trust.</h4>
            </div>
        </div>
    </div>
