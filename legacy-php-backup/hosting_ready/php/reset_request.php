...
';
            ...
            // Recipients
            $mail->setFrom('no-reply@mesfin-bank.com', 'Mesfin Digital Bank Support');
            $mail->addAddress($email, $user['fullname']);

            // Content
            $mail->isHTML(true);
            $mail->Subject = 'Password Reset Request | Mesfin Digital Bank';
            $mail->Body = "
            <div style='font-family: Arial, sans-serif; padding: 20px; color: #333;'>
                <h2 style='color: #667eea;'>Mesfin Digital Bank Support</h2>
                ...
                <br>
                <p>Best regards,<br>The Mesfin Digital Bank Security Team</p>
            </div>";

            $mail->AltBody = "Hello {$user['fullname']},\n\nWe received a request to reset your Mesfin Digital Bank password. Copy and paste the following link into your browser to choose a new password:\n\n{$reset_link}\n\nIf you did not request a password reset, you can safely ignore this email.";
