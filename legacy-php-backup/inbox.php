...
<head>
    ...
    <title>Mesfin Digital Bank | Simulated Developer Inbox</title>
            ...
            ?>
                <div class="email-item">
                    ...
                    <div class="email-body">
                        <strong style="font-size: 20px; margin-bottom: 15px; display: block; color: var(--primary-dark);">Subject: Password Reset Request | Mesfin Digital Bank</strong>
