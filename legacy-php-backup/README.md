# Mesfin Digital Bank Digital Banking System

[![PHP Version](https://img.shields.io/badge/PHP-8.0%2B-blue.svg)](https://php.net)
[![MySQL Version](https://img.shields.io/badge/MySQL-5.7%2B-orange.svg)](https://mysql.com)
[![License](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)
[![Status](https://img.shields.io/badge/Status-Beta-yellow.svg)](https://github.com/kidanenamhret/mesfin-bank)

Mesfin Digital Bank is a high-performance, secure digital banking platform built with PHP and MySQL. It delivers a full-spectrum financial experience, from core banking and money transfers to advanced merchant services and administrative control. Designed for elegance and security, it features a modern glassmorphism UI and forensic-level transaction tracking.
...
- **Smart Receipts** - Mesfin-style branded transaction receipts generated instantly.
...
1. Clone into your `htdocs` directory:
   ...
   ```bash
   git clone https://github.com/kidanenamhret/mesfin-bank.git
   ```

2. Import the database:

   - Open `phpMyAdmin`.
   - Create a database: `mesfin_bank`.
...
4. Launch in Browser:
   ...
   `http://localhost/mesfin-bank/index.php`
...
2. Browse to `http://192.168.1.5/mesfin-bank/` on your mobile.
