...
<head>
    <meta charset="UTF-8">
    <title>Mesfin Official Receipt - <?php echo $ref; ?></title>
    <style>
    ...
    <div class="receipt-container">
        ...
        <div class="stamp-overlay">
            <div class="stamp-circle">
                ...
                <div style="font-size: 7px; margin-top: 2px;">MESFIN DIGITAL BANK CORE ENGINE</div>
            </div>
        </div>
        ...
        <div class="content">
            <div class="info-sections">
                <div class="info-col">
                    ...
                    <div class="info-row"><div class="label">SWIFT Code:</div><div class="val">MSFNETAA</div></div>
                    <div class="info-row"><div class="label">Email:</div><div class="val">info@mesfinbank.com</div></div>
